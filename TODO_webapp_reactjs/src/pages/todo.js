  ...
  return (
    <div className="container">
      ...
      <div>
        ...
        <button className="addBtn" onClick={handle}>Add</button>
      </div>
      <div className="todos">
        {data.length === 0 ? <p style={{textAlign: "center"}}>No Todo's To Show</p> : <TodoList data={data} handleDelete={handleDelete} handleDone={handleDone}/>}
      </div>
    </div>
  );
}
