...
const Locker = ({handleLogin}) => {
  ...
  return (
    <div className="locker">
        ...
        <div className="row">
            <button value="1" onClick={handlePassword}>1</button>
            <button value="2" onClick={handlePassword}>2</button>
            <button value="3" onClick={handlePassword}>3</button>
        </div>
        <div className="row">
            <button value="4" onClick={handlePassword}>4</button>
            <button value="5" onClick={handlePassword}>5</button>
            <button value="6" onClick={handlePassword}>6</button>
        </div>
        <div className="row">
            <button value="7" onClick={handlePassword}>7</button>
            <button value="8" onClick={handlePassword}>8</button>
            <button value="9" onClick={handlePassword}>9</button>
        </div>
        <div className="row">
            <button value="0" onClick={handlePassword}>0</button>
        </div>
    </div>
  );
}
